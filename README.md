...
本项目是基于 [OmniAgent](https://gitee.com/coting/OmniAgent) 的二次开发版本，在此感谢原作者 **coting** 的开源贡献。原项目为我们提供了一个优秀的AI系统架构基础，让我们能够在现有基础上进行定制化改进和功能扩展。

开源精神推动技术进步，希望这个二开版本也能为社区带来价值。
